...
const AppointmentBox: React.FC<{
  ...
  clinicName: string;
  onClose: () => void;
}> = ({ appointmentId, clinicName, onClose }) => {
      ...
      <div className="bg-white p-6 rounded-xl w-3/5 h-auto max-w-2xl shadow-xl relative flex flex-col items-center overflow-auto max-h-[70vh]">
        ...
        <div className="flex flex-col items-center mt-4 px-4 space-y-4">
          ...
          <div className="bg-purple-200 p-3 rounded-lg shadow-md flex flex-col items-center gap-2 w-64">
            <p className="text-purple-700 text-md font-semibold">
              Saati değiştir
            </p>
            <button
        ...
        {successMessage && (
          <p className="text-green-500 text-xl font-bold mt-4 text-center">
            {successMessage}
          </p>
        )}
        ...
        <button
          ...
          className="mt-4 bg-green-500 text-white w-4/5 py-3 rounded-lg text-xl font-bold hover:bg-green-700 transition-all"
        >
